...
contract CryptoDevToken is ERC20, Ownerble {
    ...
    //It needs to be represented as 10*(10**18)as ERC20 tokens are represented by the smallest denomintion possible for the token
    //By default,ERC20 tokens have the smallest denomination of 10^(-18). This means, having balance of(1) is actually equal to (10^18) tokens.
    //Owning 1full token is equivalent to owning(10^18)tokens when you account for the decimal places. 
